...
class VTS_Clean_Text_List:
    ...
    def notify(self, text_list):
        cleaned_text_list = []

        for cleaned_text in text_list:
            # loop through each cleaned_text twice
            for i in range(2):
...
NODE_CLASS_MAPPINGS = {
    "VTS Clean Text List": VTS_Clean_Text_List
}

# A dictionary that contains the friendly/humanly readable titles for the nodes
NODE_DISPLAY_NAME_MAPPINGS = {
    "VTS Clean Text List": "Clean Text List"
}
